...
// If action is update
	...
	// Form the query
	$sql = "UPDATE wj18sawy_pages SET title = '$title', content = '$content', parent = '$parent' WHERE pageid='$id'";
	...
	// Echo feedback
	echo '
		<p><a href="index.php?pageid='.$id.'">'.$id.'</a> was updated from wj18sawy_pages</p>';
...
// If the id is given but action is not update
	...
	$result = run_query("SELECT * FROM wj18sawy_pages WHERE pageid='$id'");
